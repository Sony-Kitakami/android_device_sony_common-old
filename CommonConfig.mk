...
BOARD_KERNEL_CMDLINE += msm_rtb.filter=0x3F ehci-hcd.park=3 lpm_levels.sleep_disabled=1
...
# Audio
#BOARD_USES_ALSA_AUDIO := true Exclude as we are using proprietary audio
